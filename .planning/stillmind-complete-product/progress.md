...
- Added `npm run status:launch`, a repository-grounded status reporter that separates completed engineering gates from EAS, Apple, legal, real-device, and seed-user external gates.
