...
// The server's provider deadline is 8.5s. Do not abandon a valid response at 3.5s.
// Network overhead can still exhaust this budget; this is not a production latency guarantee.
export async function requestCinema(trigger: string, timeoutMs = 10_000): Promise<CinemaResult | undefined> {
